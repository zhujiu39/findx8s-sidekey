...
test('批量勾选按选择顺序排列，自动更新名称图标，保留开关并统一小窗', () => {
  ...
  assert.deepEqual(result, [{...toggle,slot:0},{slot:1,name:'新应用',icon:'',type:'app_freeform',argument:'com.new'}, {...entry(2,'camera'),name:'相机',icon:'',type:'app_freeform'}]);
